...
Download the model files from [Zenodo](https://zenodo.org/records/17608734), [Hugging Face](https://huggingface.co/zhangxutao/AI-GAMFS) or [Baidu Netdisk](https://pan.baidu.com/s/114AA56EOovz6S3sadc_FHA?pwd=5xhg) and place them in the model folder.
...
- **Note**: Test GEOS-FP data is provided for quick verification. Download from [Hugging Face](https://huggingface.co/zhangxutao/AI-GAMFS/tree/main), [Zenodo](https://zenodo.org/uploads/17608734) or [Baidu Netdisk](https://pan.baidu.com/s/114AA56EOovz6S3sadc_FHA?pwd=5xhg) and replace the contents of the temp_asm folder with the downloaded files.
